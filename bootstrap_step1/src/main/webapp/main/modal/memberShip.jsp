	      ...
	      <div class="modal-body">	      
			<form class="row g-3" id="f_member">
			  <div class="col-md-6">
			    ...
			    <input type="text" class="form-control" id="mem_id" name="mem_id" value='haha3'>
			  </div>
			  <div class="col-md-6">
			    <label for="비밀번호" class="form-label">비밀번호</label>
			    <input type="password" class="form-control" id="mem_pw" name="mem_pw" value='123'>
			  </div>
			  <div class="col-md-12">
			    <label for="이름" class="form-label">이름</label>
			    <input type="text" class="form-control" id="mem_name" name="mem_name" value='하하3'>
			  </div>
			  <div class="col-md-3">
