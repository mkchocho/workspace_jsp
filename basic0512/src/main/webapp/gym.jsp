...
<!-- f3fbd88572f48f2bd5fdfcb89cbc3aa0  -->
<script type="text/javascript" src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=f3fbd88572f48f2bd5fdfcb89cbc3aa0"></script>
</head>
<body>
<!--======================== header start  ========================-->
	...
	<div class="main">
		...
		<div class="mapwrap">
			...
			<script type="text/javascript">
				...
				//배열 선언 - 마커를 여러개 표시하고 싶은 경우일 때 참고 
				//자바 스크립트 배열 복습 → 깊은 복사(새로운 배열 생성해서 사용함)와 얕은 복사(원본 사용함)
				const positions = [
					{
						content: "<div style='padding:5px;'><h4>구디아카데미</h4><img src='./images/gudi.png'></div>",
				...
				const infoWindow = new kakao.maps.InfoWindow({
					//생성자 안에 좌중괄호 우중괄호를 붙이면 실행문 작성가능함
